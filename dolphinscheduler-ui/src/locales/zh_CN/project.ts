...
export default {
  ...
  workflow: {
    ...
    create_workflow: '创建测试项目',
    create_workflow_dynamic: '创建测试项目 (动态)',
    import_workflow: '导入测试项目',
    workflow_name: '测试项目名称',
    workflow_instance_name: '测试项目实例名称',
    current_selection: '当前选择',
    online: '已上线',
    offline: '已下线',
    refresh: '刷新',
    show_hide_label: '显示 / 隐藏标签',
    workflow_offline: '测试项目下线',
    schedule_offline: '调度下线',
    schedule_start_time: '定时开始时间',
    schedule_end_time: '定时结束时间',
    crontab_expression: 'Crontab',
    workflow_publish_status: '测试项目上线状态',
    ...
    time_up_line: '定时上线',
    time_down_line: '定时下线',
    copy_workflow: '复制测试项目',
    copy_workflow_name: '复制测试项目名称',
    visit_workflow_instances: '查看测试项目实例',
    cron_manage: '定时管理',
    delete: '删除',
    tree_view: '测试项目树形图',
    tree_limit: '限制大小',
    ...
    executor: '执行用户',
    host: '主机',
    start_process: '启动测试项目',
    execute_from_the_current_node: '从当前节点开始执行',
    recover_tolerance_fault_process: '恢复被容错的测试项目',
    ...
    project_name: '项目名称',
    project_tips: '请选择项目',
    workflow_relation_no_data_result_title: '测试项目关系不存在',
    workflow_relation_no_data_result_desc:
      '目前没有任何测试项目，请先创建测试项目，再访问该页面',
    ready_to_block: '准备锁定',
    block: '锁定',
    want_to_set_timing: '现在想去配置该测试项目定时?',
    confirm_to_online: '是否确定上线该测试项目?',
    confirm_to_offline: '是否确定下线该测试项目?',
  ...
  task: {
    ...
    workflow_instance: '测试项目实例',
    workflow_name: '测试项目名称',
    workflow_name_tips: '请选择测试项目名称',
    workflow_state: '测试项目状态',
    version: '版本',
    current_version: '当前版本',
    switch_version: '切换到该版本',
    confirm_switch_version: '确定切换到该版本吗?',
  ...
  dag: {
    ...
    online_directly: '是否上线测试项目定义',
    update_directly: '是否更新测试项目定义',
  ...
  node: {
    ...
    success: '成功',
    failed: '失败',
    backfill_tips: '新创建子测试项目还未执行，不能进入子测试项目',
    task_instance_tips: '该任务还未执行，不能进入子测试项目',
    ...
    config_content: 'dataFaker配置内容',
    config_content_tips: '请填写dataFaker配置内容',
    data_number: 'dataFaker 数据条数内容',
    data_number_tips: '请填写dataFaker 数据条数内容',
    model_content: 'model内容',
    model_content_tips: '请填写model内容',
    model_schema_content: 'model schema 配置内容',
    model_schema_content_tips: '请填写model schema 配置内容',
    main_package: '主程序包',
    ...
    emr_flow_define_json_tips: '请输入测试项目定义',
  ...
  preference: {
    ...
    instruction_tips: '下面这些项目偏好配置将影响这个项目下的所有测试项目和任务。当创建测试项目和任务时，这些配置将影响组件中的默认选项',
    success: '成功',
    submit: '提交',
    enabled: '启用',
    disabled: '未启用'
